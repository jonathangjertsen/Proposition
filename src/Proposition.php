...
class Proposition
{
     ...
     *
     * For example, if you pass ONE generator into given(), the $assumption that you pass into check($assumption) should
     * be a callable which takes a single argument. The value of that argument will be generated by the generator you
     * passed into $given. And if given() is called with TWO generators, the value of $assumption should take TWO
     ...
     *                                $hypothesis returned.
     */
    public function check(callable $hypothesis, $return_values = false)
    {
        $results = [];
